...
import replicate
import io
import base64  # base64モジュールを再度インポート
import requests
...
upload_file = st.file_uploader('Drag and drop file here', type=['jpg', 'jpeg', 'png'])
if upload_file is not None:
    # アップロードされたファイルをバイトストリームとして読み込む
        ...
        with st.spinner('画像生成中'):
            try:
                if canvas_result.image_data is not None:
                    ...
                    # request_params = {  # official smaple
